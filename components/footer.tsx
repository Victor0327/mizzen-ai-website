...
export function Footer() {
  return (
    <footer className="bg-neutral-900 dark:bg-black" aria-labelledby="footer-heading">
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-neutral-300">
              Powering the next generation of AI with high-quality data and evaluation infrastructure.
            </p>
        ...
        <div className="mt-12 border-t border-neutral-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-xs leading-5 text-neutral-400">
              &copy; 2025 MizzenAI, Inc. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0 flex space-x-6">
              {footerNavigation.legal.map((item) => (
                <Link key={item.name} href={item.href} className="text-xs leading-5 text-neutral-400 hover:text-white transition-colors">
                  {item.name}
                </Link>
              ))}
            </div>
